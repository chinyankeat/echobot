...
//=========================================================
// Chin Yan Keat: add codes below to make this into library. Remember to add the last few lines of this file also. 
var util = require('util');
var builder = require('botbuilder');

var lib = new builder.Library('uidemo');
//=========================================================
...
lib.beginDialogAction('weather', '/weather');   // <-- no 'matches' option means this can only be triggered by a button.
